...
public class JugadorMovimiento : JugadorComponente
{
    ...
    void Mover()
    {
        ...
        // Rotaremos sólo si hay dirección de movimiento
        // Se comprueba para no aplicar un vector cero a la rotación
        #region Rotación
        if (EstaMoviendose)
        {
    ...
    void AplicarGravedad()
    {
        ...
        // Se usa isGrounded ya que EstaEnSuelo es sólo para la etiqueta "Suelo"
...
/*
 * PROBLEMAS
 * - Si la cámara está boca abajo y mira al objetivo presenta problemas de movimiento
 */
